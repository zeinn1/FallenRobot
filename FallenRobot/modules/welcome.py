...
WELC_MUTE_HELP_TXT = (
    "يمكنك جعل الروبوت يقوم بكتم صوت الأشخاص الجدد الذين ينضمون إلى مجموعتك وبالتالي منع spambots من إغراق مجموعتك." 
    "الخيارات التالية ممكنة: \n" "•` / welcomeemute soft` *: * يقيد الأعضاء الجدد من إرسال الوسائط لمدة 24 ساعة. \n "
    " • `/ welcomeemute strong` *: * كتم صوت الأعضاء الجدد حتى ينقروا على زر وبالتالي التحقق من أنهم بشر. \n"
     "•` / welcomeemute off` *: * إيقاف welcomeemute. \n "
     " * ملاحظة: * يقوم الوضع القوي بطرد المستخدم من الدردشة إذا لم يقم بالتحقق خلال 120 ثانية. يمكنه دائمًا الانضمام مرة أخرى بالرغم من ذلك "
)
...
__help__ = """
* المسؤولون فقط: * 
❍ / مرحبًا <تشغيل / إيقاف> *: * تمكين / تعطيل رسائل الترحيب. 
❍ / مرحبًا *: * يعرض إعدادات الترحيب الحالية. 
❍ / welcome noformat *: * يُظهر إعدادات الترحيب الحالية ، بدون التنسيق - مفيد لإعادة تدوير رسائل الترحيب الخاصة بك! 
❍ / وداعًا *: * نفس الاستخدام والأرقام مثل "/ مرحبًا". ❍ / setwelcome <sometext> *: * تعيين رسالة ترحيب مخصصة. إذا تم استخدامه للرد على الوسائط ، يستخدم تلك الوسائط. 
❍ / setgoodbye <sometext> *: * تعيين رسالة وداع مخصصة. إذا تم استخدامه للرد على الوسائط ، يستخدم تلك الوسائط. 
❍ / resetwelcome *: * إعادة التعيين إلى رسالة الترحيب الافتراضية. ❍ / resetgoodbye *: * إعادة التعيين إلى رسالة الوداع الافتراضية. 
❍ / cleanwelcome <تشغيل / إيقاف> *: * عند العضو الجديد ، حاول حذف رسالة الترحيب السابقة لتجنب إرسال رسائل غير مرغوب فيها إلى الدردشة. 
❍ / welcomeemutehelp *: * يعطي معلومات حول كتم صوت الترحيب. 
❍ / cleanservice <on / off *: * حذف البرقيات الترحيبية / رسائل الخدمة اليسرى. * مثال: * انضم المستخدم إلى الدردشة ، وترك المستخدم الدردشة. * علامة التخفيض المرحب بها: * 

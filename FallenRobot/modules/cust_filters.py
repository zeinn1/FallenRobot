...
__help__ = """
 ❍ /عوامل التصفية *: * سرد كافة المرشحات النشطة المحفوظة في الدردشة. * المسؤول فقط: * 
 
 ❍ /عامل التصفية <كلمة رئيسية> <رسالة الرد> *: * إضافة عامل تصفية لهذه الدردشة. سيقوم الروبوت الآن بالرد على هذه الرسالة متى تم ذكر "الكلمة الرئيسية" \. إذا قمت بالرد على ملصق بكلمة رئيسية ، فسوف يرد الروبوت بهذا الملصق. ملاحظة: كافة عوامل التصفية \ الكلمات الأساسية بأحرف صغيرة. إذا كنت تريد أن تكون كلمتك الرئيسية جملة ، فاستخدم علامات الاقتباس. على سبيل المثال: / filter "hey there" How you \ doin؟ ردود فرق منفصلة بـ `٪٪٪ 'للحصول على ردود عشوائية * مثال: *` / filter "filtername" رد 1 ٪٪٪ رد 2 ٪٪٪ 3` 
 ❍ / stop <filter keyword> *: * أوقف هذا المرشح. * منشئ الدردشة فقط: * 
 ❍ / removeallfilters *: * قم بإزالة جميع عوامل تصفية الدردشة مرة واحدة. * ملاحظة *: تدعم الفلاتر أيضًا تنسيقات التخفيضات مثل: {first} و {last} وما إلى ذلك .. والأزرار. تحقق من 
 ❍ / markdown help لمعرفة المزيد!

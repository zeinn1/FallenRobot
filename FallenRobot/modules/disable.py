...
if is_module_loaded(FILENAME):
    ...
    __help__ = """
   ❍ / cmds *: * تحقق من الحالة الحالية للأوامر المعطلة * المسؤولون فقط: * 
   
   ❍ / enable <cmd name> *: * تمكين هذا الأمر 
   ❍ / disable <cmd name> *: * تعطيل هذا الأمر 
   ❍ / enablemodule <اسم الوحدة > *: * تمكين جميع الأوامر في تلك الوحدة 
   ❍ / disablemodule <اسم الوحدة النمطية> *: * تعطيل جميع الأوامر في تلك الوحدة 
   ❍ / listcmds *: * سرد جميع الأوامر الممكنة للتبديل
    """

    __mod_name__ = "التفعيل والتعطيل"

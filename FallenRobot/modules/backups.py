...
def import_data(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        try:
            ...
            msg.reply_text(
                "حاول تنزيل الملف وتحميله بنفسك مرة أخرى ، يبدو أن هذا الملف معطل بالنسبة لي!"
            )
            return
        ...
        if len(data) > 1 and str(chat.id) not in data:
            msg.reply_text(
                "هناك أكثر من مجموعة في هذا الملف و chat.id ليس هو نفسه! كيف لي أن أستوردها?"
            )
            return
...
__help__ = """
** فقط لمالك المجموعة: * 
❍ / import: قم بالرد على ملف النسخ الاحتياطي لمجموعة كبير الخدم / emilia لاستيراد أكبر قدر ممكن ، مما يجعل عمليات النقل سهلة للغاية! \ لاحظ أنه لا يمكن استيراد الملفات / الصور بسبب قيود التلغرام. 
❍ /export: تصدير بيانات المجموعة ، والتي سيتم تصديرها هي: القواعد ، والملاحظات (المستندات ، والصور ، والموسيقى ، والفيديو ، والصوت ، والصوت ، والنص ، وأزرار النص) \
"""

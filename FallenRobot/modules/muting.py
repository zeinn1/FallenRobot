...
__help__ = """
*الادمن
 ❍ /mute <userhandle>*:* يسكت المستخدم. يمكن أيضًا استخدامه كرد ، كتم صوت الرد للمستخدم..
 ❍ /tmute <userhandle> x(m/h/d)*:* كتم صوت المستخدم لوقت x. (عن طريق التعامل أو الرد). `m` =` minutes` ، `h` =` ساعات` ، `d` =` أيام`.
 ❍ /unmute <userhandle>*:* لالغاء الكتم
"""

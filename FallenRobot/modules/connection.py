...
__help__ = """
في بعض الأحيان ، تريد فقط إضافة بعض الملاحظات والفلاتر إلى دردشة جماعية ، لكنك لا تريد أن يراها الجميع ؛ هذا هو المكان الذي تأتي فيه الاتصالات ... يتيح لك ذلك الاتصال بقاعدة بيانات الدردشة وإضافة أشياء إليها دون ظهور الأوامر في الدردشة! لأسباب واضحة ، يجب أن تكون مسؤولاً لإضافة أشياء ؛ لكن أي عضو في المجموعة يمكنه عرض بياناتك. 
❍ / connect: يتصل بالدردشة (يمكن إجراؤه في مجموعة عن طريق / connect أو / connect <chat id> in PM) 
❍ / الاتصال: قائمة الدردشات المتصلة 
❍ / قطع الاتصال: قطع الاتصال بالمحادثة 
❍ / helpconnect: سرد الأوامر المتاحة التي يمكن استخدامها عن بعد * المسؤول فقط: * 
❍ / allowconnect <نعم / لا>: السماح للمستخدم بالاتصال بالمحادثة
"""

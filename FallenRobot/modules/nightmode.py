...
__help__ = """
*الادمن
 ❍ /nightmode*:* يضيف المجموعة إلى NightMode Chats
 ❍ /rmnight*:* إزالة المجموعة من دردشات الوضع الليلي

* ملاحظة: * يتم إغلاق محادثات الوضع الليلي تلقائيًا في الساعة 12 صباحًا (بتوقيت الهند الصينية) وتفتح تلقائيًا في الساعة 6 صباحًا (بتوقيت الهند الصينية) لمنع التشنجات الليلية.
"""

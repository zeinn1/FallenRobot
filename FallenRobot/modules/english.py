...
__help__ = """
 ❍ /define <text>*:* اكتب الكلمة أو التعبير الذي تريد البحث عنه \n على سبيل المثال / عرّف القتل
 ❍ /spell*:* أثناء الرد على رسالة ، سيتم الرد بإصدار تم تصحيحه نحويًا
 ❍ /synonyms <word>*:* ابحث عن مرادفات كلمة
 ❍ /antonyms <word>*:* ابحث عن المتضادات لكلمة
"""

__mod_name__ = "انجليزي"

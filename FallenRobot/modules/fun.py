...
__help__ = """
 ...
 ❍ /shrug*:* تجاهل XD
 ❍ /table*:* الحصول flip/unflip :v
 ❍ /decide*:* اجابة عشوائيه yes/no/maybe
 ❍ /toss*:* ملك او كتابة
 ❍ /bluetext*:* فحص نفسك :V
 ❍ /roll*:* لفة النرد
 ❍ /rlg*:* ربط الأذنين والأنف والفم وإنشاء emoJoin الأذنين والأنف والفم وإنشاء emo ;-;
 ❍ /shout <keyword>*:* اكتب أي شيء تريد أن تطلقه بصوت عالٍ
 ❍ /weebify <text>*:* إرجاع نص ويبييد
 ❍ /sanitize*:* استخدم هذا دائمًا قبل / pat أو أي جهة اتصال
 ❍ /pat*:* يربت مستخدمًا أو يربت عليه

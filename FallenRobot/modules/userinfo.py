...
def set_about_me(update: Update, context: CallbackContext):
    ...
    if user_id in [777000, 5190136458]:
    ...
    if message.reply_to_message:
        ...
        if repl_user_id in [bot.id, 777000, 5190136458] and (user_id in DEV_USERS):
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id in [777000, 5190136458] and sender_id not in DEV_USERS:
...
❍ / id *: * احصل على معرف المجموعة الحالي. إذا تم استخدامه من خلال الرد على رسالة ، يحصل على معرف هذا المستخدم. 
❍ / gifid *: * رد على gif لي لأخبرك بمعرف الملف الخاص به.

* المعلومات المضافة ذاتيًا: * 
❍ / setme <text> *: * ستضبط معلوماتك 
❍ / me *: * ستحصل على معلوماتك أو معلومات مستخدم آخر. * أمثلة: * ➩ / setme أنا ذئب. ➩ / meusername (الإعدادات الافتراضية لك إذا لم يتم تحديد مستخدم)

*المعلومات التي يضيفها الآخرون عنك: * 

❍ / bio *: * ستحصل على السيرة الذاتية الخاصة بك أو لمستخدم آخر. هذا لا يمكن أن تحدده بنفسك. 
❍ / setbio <text> *: * أثناء الرد ، سيتم حفظ السيرة الذاتية لمستخدم آخر * أمثلة: * ➩ / biousername (افتراضيات لك إذا لم يتم تحديدها) .` ➩ / setbio هذا المستخدم ذئب` (رد على المستخدم )

* معلومات عامة عنك: * 
❍ / info *: * الحصول على معلومات عن مستخدم. 
❍ / myinfo *: * يعرض معلومات عن المستخدم الذي أرسل هذا الأمر.
"""

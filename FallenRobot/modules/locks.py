...
__help__ = """
هل الملصقات تزعجك؟ أو تريد تجنب مشاركة الأشخاص للروابط؟ او الصور؟ \ أنت في المكان الصحيح! تتيح لك وحدة الأقفال قفل بعض العناصر الشائعة في عالم \ telegram ؛ سيقوم الروبوت بحذفها تلقائيًا!

 ❍ /locktypes*:* يسرد جميع أنواع القفل الممكنة
 
* المسؤولون فقط: * 

❍ / lock <type> *: * قفل العناصر من نوع معين (غير متوفر بشكل خاص) 
❍ / unlock <type> *: * فتح عناصر من نوع معين (غير متاح في القطاع الخاص) 
❍ / locks *: * القائمة الحالية للأقفال في هذه الدردشة.
 
يمكن استخدام الأقفال لتقييد مستخدمي المجموعة. على سبيل المثال: سيؤدي قفل عناوين url إلى حذف جميع الرسائل التي تحتوي على عناوين url تلقائيًا ، 
وسيؤدي قفل الملصقات إلى تقييد جميع المستخدمين / غير الإداريين من إرسال الملصقات ، وما إلى ذلك. سيؤدي قفل برامج التتبع إلى منع غير المسؤولين من إضافة برامج الروبوت إلى الدردشة.

*المحفوظات:*
• فتح الإذن * المعلومات * سيسمح للأعضاء (غير المسؤولين) بتغيير معلومات المجموعة ، مثل الوصف أو اسم المجموعة 
• سيسمح فتح الإذن * pin * للأعضاء (غير المسؤولين) بتثبيت رسالة في مجموعة
"""

__mod_name__ = "القفل والفتح"

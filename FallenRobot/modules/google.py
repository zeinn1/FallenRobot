...
__help__ = """
 ❍ / google <text> *: * قم بإجراء بحث على google 
 ❍ / img <text> *: * ابحث في Google عن الصور وقم بإرجاعها \ n لمزيد من لا. من النتائج تحديد محدود ، على سبيل المثال: `/ img hello lim = 10` 
 ❍ / app <appname> *: * البحث عن تطبيق في متجر Play وإرجاع تفاصيله. 
 ❍ / reverse | pp | grs: إجراء بحث عكسي عن الصورة للوسائط التي تم الرد عليها.

...
__help__ = """
يستخدم ملصق القائمة السوداء لإيقاف بعض الملصقات. عندما يتم إرسال ملصق ، سيتم حذف الرسالة على الفور. * ملاحظة: * لا تؤثر ملصقات القائمة السوداء على مسؤول المجموعة 
❍ / blsticker *: * شاهد الملصق الموجود بالقائمة السوداء الحالي * المسؤول فقط: * 
❍ / addblsticker <رابط الملصق> *: * أضف مشغل الملصق إلى القائمة السوداء. يمكن إضافته عبر ملصق الرد 
❍ / unblsticker <رابط الملصق> *: * إزالة المشغلات من القائمة السوداء. ينطبق نفس منطق السطر الجديد هنا ، لذا يمكنك حذف عدة مشغلات في وقت واحد 
❍ / rmblsticker <sticker link> *: * كما هو مذكور أعلاه 
❍ / blstickermode <ban / tban / mute / tmute> *: * يقوم بإعداد إجراء افتراضي على ماذا للقيام بذلك إذا كان المستخدمون يستخدمون الملصقات المدرجة في القائمة السوداء ملاحظة: <رابط الملصق> يمكن أن يكون `` https://t.me/addstickers/ <sticker> `أو فقط` <sticker> `أو الرد على رسالة الملصق
"""

__mod_name__ = "الاستكيرات"

...
__mod_name__ = "المحظورين"

__help__ = """

تُستخدم القوائم السوداء لمنع قول محفزات معينة في المجموعة. في أي وقت يذكر المشغل ، سيتم حذف الرسالة على الفور. السرد الجيد في بعض الأحيان هو إقران هذا مع مرشحات التحذير! * ملاحظة *: لا تؤثر القوائم السوداء على مسؤولي المجموعة. 
❍ / blacklist *: * اعرض الكلمات المدرجة في القائمة السوداء الحالية. المسؤول فقط: 
...
❍ / unblacklist <triggers> *: * إزالة المشغلات من القائمة السوداء. ينطبق منطق السطر الجديد نفسه هنا ، لذا يمكنك إزالة عدة مشغلات في وقت واحد. 

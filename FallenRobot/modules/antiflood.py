...
__help__ = """
* Antiflood *
 يسمح لك باتخاذ إجراء بشأن المستخدمين الذين يرسلون أكثر من x من الرسائل على التوالي. سيؤدي تجاوز فيضان المجموعة \ إلى تقييد هذا المستخدم. سيؤدي هذا إلى كتم صوت المستخدمين إذا أرسلوا أكثر من 10 رسائل متتالية ، فسيتم تجاهل برامج الروبوت. 
 ❍ / فيضان *: * الحصول على إعداد التحكم في الفيضان الحالي • * المسؤولون فقط: * 
 ❍ / setflood <int / 'no' / 'off'> *: * تمكين التحكم في الفيضان أو تعطيله * مثال: * `/ setflood 10` 
 ❍ / setfloodmode <ban / kick / mute / tban / tmute> <value> *: * الإجراء المطلوب تنفيذه عندما يتجاوز المستخدم حد الفيضان. ban / kick / mute / tmute / tban • * ملاحظة: * • يجب تعبئة القيمة لـ tban و tmute !! يمكن أن يكون: "5 م" = 5 دقائق "6 ساعات" = 6 ساعات "3 د" = 3 أيام "أسبوع واحد" = أسبوع واحد 
 """

__mod_name__ = "الحماية"

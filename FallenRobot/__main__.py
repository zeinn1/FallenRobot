...
buttons = [
    [
        InlineKeyboardButton(
            text="آضـفنيـﮯ آليـﮯ مـجمـوعتگ",
            url=f"https://t.me/{BOT_USERNAME}?startgroup=true",
        ),
    ],
    [
        InlineKeyboardButton(text="🔱آلآوآمـر🔱", callback_data="help_back"),
    ],
    [
        InlineKeyboardButton(text="❄ حول البوت ❄", callback_data="fallen_"),
        InlineKeyboardButton(text="✨قنآ‏‏هہ آلسـورسـ✨", url=f"https://t.me/S_EG_P"),
    ],
    [
        InlineKeyboardButton(text="🥀 آلمـطـور زيـﮯن 🥀", url=f"tg://user?id=5190136458"),
    ],
]
...
➲ /help  : آلآوآمـر آلمـسـآعد‏‏هہ
  ‣ فيـﮯ آلخآصـ : سـيـﮯفتح لگ آلآوآمـر 
  ‣  فيـﮯ آلبآر : هہ‏‏يـﮯودگ آلخآصـ تشـوف آلآوآمـر هہ‏‏نآگ."""
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="آلمـسـآعد‏‏هہ", callback_data="fallen_support"
                        ),
                        InlineKeyboardButton(
                            text="الاوامر", callback_data="help_back"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text="المطور زين", url=f"tg://user?id=5190136458"
                        ),
                        InlineKeyboardButton(
                            text="سورس",
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="المساعدة", url=f"https://t.me/{SUPPORT_CHAT}"
                        ),
                        InlineKeyboardButton(
                            text="قناة السورس", url=f"https://t.me/S_EG_P"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
